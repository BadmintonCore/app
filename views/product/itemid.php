                ...
                <div class="info">
                    ...
                    <form class="flex-align-left" id="itemIdForm">
                        ...
                        <div class="button-row">
                            <button type="submit" class="btn" name="buy_direct" id="orderButton">Direkt bestellen
                            </button>
    ...
    <?php if ($product2 !== null) : ?>
        <div class="details-flex">
            ...
            <div class="info">
                ...
                <h2 class="price-field" id="priceText"><?= $product2["price"] ?><small class="fee-field">&nbsp;inkl. 19%
                        MwSt.</small></h2>
