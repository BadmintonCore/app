...
return [
    ...
    '/about-us' =>  [AboutUsController::class, 'root'],
    ...
    '/customer-service' => [CustomerServiceController::class, 'root'],
    ...
    '/legal' =>  [LegalController::class, 'root'],
    ...
    '/your-purchase' => [YourPurchaseController::class, 'root'],
