...
<main>
    <div class="details-flex">
        ...
        <img src="/img/tshirt-beige.webp" alt="product image"/>
        ...
        <div class="info">
            ...
            <form class="flex-align-left" id="itemIdForm">
                ...
                <button type="submit" class="wishlist-btn" name="add_to_wishlist" id="addToWishlistButtonEmpty">
                ...
                <button class="wishlist-btn" name="add_to_wishlist" id="addToWishlistButtonFilled">
                ...
                <div class="button-row">
                    ...
                    <button type="submit" class="btn secondary" name="add_to_cart" id="addToCartButton">Zum Warenkorb
                        hinzufügen
                    </button>
                </div>
            </form>
