...
<footer>
    ...
    <div class="footer-categories">
        ...
        <div class="footer-category">
            <h4>Über uns</h4>
            <a href="/about-us/about.php">Das sind wir</a>
            <a href="/about-us/jobs.php">Jobs</a>
            <a href="/about-us/press.php">Presse</a>
            <a href="/about-us/responsibility.php">Verantwortung</a>
        </div>
        ...
        <div class="footer-category">
            ...
            <a href="/customer-service/user.php">Benutzerbereich</a>
        </div>

        <!--Container der Klasse "footer-category"-->
        <div class="footer-category">
            <h4>Dein Einkauf</h4>
            <a href="/your-purchase/order.php">Fragen zur Bestellung</a>
            <a href="/your-purchase/paymentmethods.php">Zahlungsmethoden</a>
            <a href="/your-purchase/shipment.php">Versand und Lieferung</a>
            <a href="/your-purchase/vouchers.php">Online-Gutscheine</a>
        </div>

        <!--Container der Klasse "footer-category"-->
        <div class="footer-category">
            <h4>Rechtliches</h4>
            <a href="/legal/impress.php">Impressum</a>
            <a href="/legal/gtc.php">AGBs</a>
            <a href="/legal/privacypolicy.php">Datenschutz</a>
            <a href="/legal/revocation.php">Widerrufserklärung</a>
        </div>
    </div>
    ...
    <div class="footer-accordion">
        ...
        <div class="accordion-content">
            <a href="/about-us/about.php">Das sind wir</a> <br>
            <a href="/about-us/jobs.php">Jobs</a> <br>
            <a href="/about-us/press.php">Presse</a> <br>
            <a href="/about-us/responsibility.php">Verantwortung</a>
        </div>
        ...
        <div class="accordion-content">
            <a href="/your-purchase/order.php">Fragen zur Bestellung</a> <br>
            <a href="/your-purchase/paymentmethods.php">Zahlungsmethoden</a> <br>
            <a href="/your-purchase/shipment.php">Versand und Lieferung</a> <br>
            <a href="/your-purchase/vouchers.php">Online-Gutscheine</a>
        </div>
        ...
        <div class="accordion-content">
            <a href="/legal/impress.php">Impressum</a> <br>
            <a href="/legal/gtc.php">AGBs</a> <br>
            <a href="/legal/privacypolicy.php">Datenschutz</a> <br>
            <a href="/legal/revocation.php">Widerrufserklärung</a>
        </div>
    </div>
